...
export default function Home() {
  const nextSessionDate = new Date('2025-01-13T07:00:00')

  return (
    <div className="h-screen bg-texture text-white relative flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="w-full max-w-3xl px-4 py-4 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight tracking-tight mx-auto max-w-[90%] font-sans relative">
      ...
      <div className="p-3 text-center">
        <div className="text-sm text-white/60">
          a <Link href="https://profitable.agency" target="_blank" rel="noopener noreferrer" className="underline hover:text-white/80 transition-colors">Profitable</Link> experiment
        </div>
      </div>
    </div>
  )
