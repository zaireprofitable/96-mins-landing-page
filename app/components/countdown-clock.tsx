...
export function CountdownClock({ targetDate }: CountdownClockProps) {
  ...
  return (
    <div className="bg-[#36454F]/50 backdrop-blur-sm text-white p-4 rounded-lg shadow-md inline-block">
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        {Object.entries(timeLeft).map(([unit, value]) => (
          <div key={unit} className="flex flex-col items-center">
            <div className="text-2xl font-bold font-mono bg-[#36454F]/20 p-2 rounded-md w-14">
              {padWithZero(value)}
            </div>
